...
export default function Page() {
    return (
        <div className="flex-col h-screen">
            ...
            <Image priority={true} className="object-cover fixed w-full h-full bg-amber-50 bg-blend-color -z-10" src={heroImage} alt="An image of a set of a set of clothing."/>
